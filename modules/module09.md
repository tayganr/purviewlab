...
4. Once the connection has been established, you will receive a notification that **Registration succeeded**. Switch to the **Purview account** tab to confirm that the Purview account is connected and the list of integration capabilities (e.g. Azure Purview search, Synapse Pipeline lineage, etc).
